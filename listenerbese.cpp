...
CListenerBese::CListenerBese(CCoordinateView *view, CDebugModeBox *box, QColor mainColor, QColor secondaryColor)
    : CAbstractListener(view, box, mainColor, secondaryColor)
{
    m_sListenerName = "Listener Bese";
    m_pAlgorithm = NULL;
    initialize();
}
...
void CListenerBese::initialize()
{
    ...
    m_pAlgorithm = new CAlgorithmBese();
}


CListenerBese::~CListenerBese()
{
    if(m_pAlgorithm!=NULL) delete m_pAlgorithm;
}

void CListenerBese::mouseMoveEvent(QPoint pos)
{
...
void CListenerBese::mousePressEvent(QPoint pos)
{
...
void CListenerBese::fixSpline()
{
    reset();
}


void CListenerBese::mouseReleaseEvent(QPoint pos)
{
    if(m_mouseClickState == MCS_MOVE)
    {
...
void CListenerBese::modeChanged(Mode mode, Mode oldMode)
{

}


void CListenerBese::drawDebugSpline(QVector<QPoint> points)
{

}


void CListenerBese::drawNormalSpline(QVector<QPoint> points)
{


}

void CListenerBese::drawSpline()
{
...
void CListenerBese::drawTempoparySpline(QVector<QPoint> pointsSpline)
{
    clearTmpObject();
    m_pAlgorithm->reset();
...
void CListenerBese::update(QVector<QPoint> points)
{
...
void CListenerBese::updateMainPoints(QVector<QPoint> points)
{
...
void CListenerBese::clearMainPoints()
{
    for(int i=0; i<m_clickPoints.size(); i++)
    {
        m_tmpUndoStack.undo();
...
void CListenerBese::setHightlightMainPoints(bool enable)
{
    m_bHighlightMainPoints = true;
}
